                    ...
                    <div class="card-body">
                        <form class="row g-3" action="{{ url('/submit_stock/' . $ingredient->id) }}" method="post">
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input name="manufacture_date" type="date" class="form-control" placeholder="Manufacture Date" max={{Carbon\Carbon::now()->format('Y-m-d')}} required>
                            </div>
                            @endif
                            ...
                            <div class="col-12 col-lg-4">
                                ...
                                <input name="expire_date" type="date" class="form-control" placeholder="Expire Date" min={{Carbon\Carbon::now()->format('Y-m-d')}} required>
                            </div>
                            @endif
