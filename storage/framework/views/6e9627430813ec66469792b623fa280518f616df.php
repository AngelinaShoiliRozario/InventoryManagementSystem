...
<main class="page-content">
    <div>
        <div class="col-lg-12 ">
            <h6 class="mb-0 text-center text-uppercase"><?php echo e($user->user_type); ?> Profile</h6>
            <div class="card">
                        ...
                        <form class="row g-3" method="post" action="/kitchener/save_profile" enctype="multipart/form-data">
                            ...
                            <div class="col-12">
                                ...
                                <div style="text-align: center;">
                                    <img src="<?php echo e(asset($user->image)); ?>" alt="" style="border-radius: 50%; border:5px solid black;" id="output">
                                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InventoryManagementSystem\resources\views/kitchen_staff/profile.blade.php ENDPATH**/ ?>