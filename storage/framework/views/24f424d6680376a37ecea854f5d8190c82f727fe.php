                    ...
                    <table id="" class="table table-striped table-bordered " style="width: 100%;table-layout:fixed;">
                        ...
                        $orders = \App\Order::where('status','pending')->orderBy('id', 'desc')->get();
                            ...
                            $details = json_decode($order->details,true);  
                                ...
                                <td >
                                    <a href=<?php echo e("/admin/check/".$order->id); ?>><span class="btn btn-primary">Check</span></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\InventoryManagementSystem\resources\views/admin/neworders.blade.php ENDPATH**/ ?>